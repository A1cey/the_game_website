			...
			(function () {
				...
				function registerDirectEvent(registrationName, dependencies) {
						...
						dependencies;
					{
						...
						if (registrationName === "onDoubleClick") {
							possibleRegistrationNames.ondblclick =
								registrationName;
						}
					}
				...
				function getComponentNameFromFiber(fiber) {
					...
					switch (tag) {
						...
						case ContextProvider:
							var provider = type;
							return (
								getContextName$1(provider._context) +
								".Provider"
							);
						case DehydratedFragment:
							return "DehydratedFragment";
						case ForwardRef:
							return getWrappedName$1(
								type,
								type.render,
								"ForwardRef",
							);
				...
				function validateProperty(tagName, name) {
					{
						...
						if (rARIACamel.test(name)) {
							...
							var correctName = ariaProperties.hasOwnProperty(
								ariaName,
							)
								? ariaName
								: null;
				...
				var validateProperty$1 = function () {};
				{
					...
					validateProperty$1 = function (
						...
						if (eventRegistry != null) {
							...
							if (
								registrationNameDependencies2.hasOwnProperty(
									name,
								)
							) {
								return true;
							...
							var registrationName =
								possibleRegistrationNames2.hasOwnProperty(
									lowerCasedName,
								)
					...
					if (
						...
						invokeGuardedCallbackImpl =
							function invokeGuardedCallbackDev(
								...
								var evtType =
									"react-" +
									(name ? name : "invokeguardedcallback");
								...
								if (!didCall) {
									restoreAfterDispatch();
									return invokeGuardedCallbackProd.apply(
										this,
										arguments,
									);
								}
				...
				function getNearestMountedFiber(fiber) {
					...
					if (!fiber.alternate) {
						...
						do {
							node = nextNode;
							if (
								(node.flags & (Placement | Hydrating)) !==
								NoFlags
							) {
						...
						if (owner !== null && owner.tag === ClassComponent) {
							...
							if (!instance._warnedAboutRefsInRender) {
								error(
									...
									getComponentNameFromFiber(ownerFiber) ||
										"A component",
								);
							}
				...
				function findCurrentHostFiberWithNoPortalsImpl(node) {
					...
					while (child !== null) {
						if (child.tag !== HostPortal) {
							var match =
								findCurrentHostFiberWithNoPortalsImpl(child);
							if (match !== null) {
								return match;
							}
						}
				...
				function onScheduleRoot(root2, children) {
					{
						if (
							injectedHook &&
							typeof injectedHook.onScheduleFiberRoot ===
								"function"
						) {
							try {
				...
				function onCommitRoot(root2, eventPriority) {
					if (
						...
						try {
							var didError =
								(root2.current.flags & DidCapture) ===
								DidCapture;
				...
				function onPostCommitRoot(root2) {
					if (
						...
						try {
							injectedHook.onPostCommitFiberRoot(
								rendererID,
								root2,
							);
						} catch (err) {
				...
				function markCommitStarted(lanes) {
					{
						if (
							...
							typeof injectedProfilingHooks.markCommitStarted ===
								"function"
						) {
				...
				function markCommitStopped() {
					{
						if (
							injectedProfilingHooks !== null &&
							typeof injectedProfilingHooks.markCommitStopped ===
								"function"
						) {
				...
				function markComponentRenderStarted(fiber) {
					{
						if (
							...
							injectedProfilingHooks.markComponentRenderStarted(
								fiber,
							);
						}
					}
				...
				function markPassiveEffectsStarted(lanes) {
					{
						if (
							...
							injectedProfilingHooks.markPassiveEffectsStarted(
								lanes,
							);
						}
					}
				...
				function markRenderStarted(lanes) {
					{
						if (
							injectedProfilingHooks !== null &&
							typeof injectedProfilingHooks.markRenderStarted ===
								"function"
						) {
				...
				function markRenderYielded() {
					{
						if (
							injectedProfilingHooks !== null &&
							typeof injectedProfilingHooks.markRenderYielded ===
								"function"
						) {
				...
				function markRenderStopped() {
					{
						if (
							injectedProfilingHooks !== null &&
							typeof injectedProfilingHooks.markRenderStopped ===
								"function"
						) {
				...
				function markRenderScheduled(lane) {
					{
						if (
							injectedProfilingHooks !== null &&
							typeof injectedProfilingHooks.markRenderScheduled ===
								"function"
						) {
				...
				function markForceUpdateScheduled(fiber, lane) {
					{
						if (
							...
							injectedProfilingHooks.markForceUpdateScheduled(
								fiber,
								lane,
							);
						}
				...
				function markStateUpdateScheduled(fiber, lane) {
					{
						if (
							...
							injectedProfilingHooks.markStateUpdateScheduled(
								fiber,
								lane,
							);
						}
				...
				function getNextLanes(root2, wipLanes) {
					...
					if (nonIdlePendingLanes !== NoLanes) {
						var nonIdleUnblockedLanes =
							nonIdlePendingLanes & ~suspendedLanes;
						if (nonIdleUnblockedLanes !== NoLanes) {
							...
							var nonIdlePingedLanes =
								nonIdlePendingLanes & pingedLanes;
							if (nonIdlePingedLanes !== NoLanes) {
								nextLanes =
									getHighestPriorityLanes(nonIdlePingedLanes);
							}
						}
					} else {
						...
						if (unblockedLanes !== NoLanes) {
							...
							if (pingedLanes !== NoLanes) {
								nextLanes =
									getHighestPriorityLanes(pingedLanes);
							}
						}
					}
				...
				function getLanesToRetrySynchronouslyOnError(root2) {
					var everythingButOffscreen =
						root2.pendingLanes & ~OffscreenLane;
				...
				function markRootEntangled(root2, entangledLanes) {
					var rootEntangledLanes = (root2.entangledLanes |=
						entangledLanes);
					var entanglements = root2.entanglements;
				...
				function getBumpedLaneForHydration(root2, renderLanes2) {
					...
					if (
						(lane & (root2.suspendedLanes | renderLanes2)) !==
						NoLane
					) {
						return NoLane;
					}
					...
					while (lanes > 0) {
						...
						if (updaters.size > 0) {
							updaters.forEach(function (fiber) {
								...
								if (
									alternate === null ||
									!memoizedUpdaters.has(alternate)
								) {
					...
					switch (domEventName) {
						...
						case "gotpointercapture": {
							...
							queuedPointerCaptures.set(
								_pointerId2,
								accumulateOrCreateContinuousQueuedReplayableEvent(
									queuedPointerCaptures.get(_pointerId2) ||
										null,
									blockedOn,
									domEventName,
									eventSystemFlags,
						...
						if (nextBlockedOn === null) {
							{
								...
								var nativeEventClone =
									new nativeEvent.constructor(
										nativeEvent.type,
										nativeEvent,
									);
								setReplayingEvent(nativeEventClone);
								nativeEvent.target.dispatchEvent(
									nativeEventClone,
								);
								resetReplayingEvent();
							}
				...
				function retryIfBlockedOn(unblocked) {
					...
					for (
						var _i = 0;
						_i < queuedExplicitHydrationTargets.length;
						_i++
					) {
					...
					while (queuedExplicitHydrationTargets.length > 0) {
						var nextExplicitTarget =
							queuedExplicitHydrationTargets[0];
				...
				function getEventKey(nativeEvent) {
					...
					if (
						...
						return (
							translateToKey[nativeEvent.keyCode] ||
							"Unidentified"
						);
					}
					return "";
				...
				function isFallbackCompositionEnd(domEventName, nativeEvent) {
					switch (domEventName) {
						case "keyup":
							return (
								END_KEYCODES.indexOf(nativeEvent.keyCode) !== -1
							);
						case "keydown":
				...
				function extractEvents$2(
					...
					if (isOutEvent) {
						...
						from = targetInst;
						to = _related
							? getClosestInstanceFromNode(_related)
							: null;
						if (to !== null) {
					...
					var fromNode =
						from == null ? win : getNodeFromInstance(from);
				...
				function isSameOriginFrame(iframe) {
					try {
						return (
							typeof iframe.contentWindow.location.href ===
							"string"
						);
					} catch (err) {
						return false;
				...
				function makePrefixMap(styleProp, eventName) {
					var prefixes2 = {};
					prefixes2[styleProp.toLowerCase()] =
				...
				function processDispatchQueueItemsInOrder(
					...
					if (inCapturePhase) {
						for (
							var i = dispatchListeners.length - 1;
							i >= 0;
							i--
						) {
							var _dispatchListeners$i = dispatchListeners[i],
								...
								currentTarget =
									_dispatchListeners$i.currentTarget,
						...
						for (var _i = 0; _i < dispatchListeners.length; _i++) {
							var _dispatchListeners$_i = dispatchListeners[_i],
								...
								_currentTarget =
									_dispatchListeners$_i.currentTarget,
				...
				function accumulateSinglePhaseListeners(
					...
					var captureName =
						reactName !== null ? reactName + "Capture" : null;
					var reactEventName = inCapturePhase
						? captureName
						: reactName;
					var listeners = [];
				...
				function diffProperties(
					...
					for (propKey in nextProps) {
						var nextProp = nextProps[propKey];
						var lastProp =
							lastProps != null ? lastProps[propKey] : void 0;
						if (
							!nextProps.hasOwnProperty(propKey) ||
							nextProp === lastProp ||
						...
						if (propKey === CHILDREN) {
							if (typeof nextProp === "string") {
								if (domElement.textContent !== nextProp) {
									if (
										rawProps[SUPPRESS_HYDRATION_WARNING] !==
										true
									) {
							...
							if (rawProps[SUPPRESS_HYDRATION_WARNING] === true);
								...
								if (propertyInfo !== null) {
									...
									if (ownNamespace === HTML_NAMESPACE) {
										...
										var standardName =
											getPossibleStandardName(propKey);
										if (
											standardName !== null &&
				...
				var updatedAncestorInfo = function () {};
				{
					...
					var findInvalidAncestorForTag = function (
						tag,
						ancestorInfo,
					) {
						switch (tag) {
				...
				var noTimeout = -1;
				var localPromise =
					typeof Promise === "function" ? Promise : void 0;
				...
				function getFirstHydratableChildWithinSuspenseInstance(
					parentInstance,
				) {
						...
						if (targetInst) {
							...
							if (
								...
								var suspenseInstance =
									getParentSuspenseInstance(targetNode);
				...
				function getMaskedContext(workInProgress2, unmaskedContext) {
					{
						...
						{
							var name =
								getComponentNameFromFiber(workInProgress2) ||
								"Unknown";
							checkPropTypes(
								contextTypes,
								context,
				...
				function getTreeId() {
					...
					var id =
						idWithLeadingBit & ~getLeadingBit(idWithLeadingBit);
				...
				function pushTreeId(workInProgress2, totalChildren, index2) {
					...
					if (length > 30) {
						var numberOfOverflowBits =
							baseLength - (baseLength % 5);
						var newOverflowBits = (1 << numberOfOverflowBits) - 1;
						var newOverflow = (baseId & newOverflowBits).toString(
							32,
						);
						var restOfBaseId = baseId >> numberOfOverflowBits;
						var restOfBaseLength =
							baseLength - numberOfOverflowBits;
						var restOfLength =
							getBitLength(totalChildren) + restOfBaseLength;
				...
				function warnUnhydratedInstance(returnFiber, instance) {
					{
						switch (returnFiber.tag) {
							...
							case HostComponent: {
								var isConcurrentMode =
									(returnFiber.mode & ConcurrentMode) !==
									NoMode;
					...
					switch (fiber.tag) {
						case HostComponent: {
							...
							if (instance !== null) {
								...
								hydrationParentFiber = fiber;
								nextHydratableInstance =
									getFirstHydratableChild(instance);
								return true;
							}
							return false;
						}
				...
				};
				{
						...
						function (fiber, instance) {
							...
							if (
								typeof instance.componentWillMount ===
									"function" && // Don't warn about react-lifecycles-compat polyfilled components.
					...
					ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings =
						function () {
							...
							var UNSAFE_componentWillMountUniqueNames =
								/* @__PURE__ */ new Set();
							if (
								pendingUNSAFE_ComponentWillMountWarnings.length >
								0
							) {
							...
							var componentWillReceivePropsUniqueNames =
								/* @__PURE__ */ new Set();
							if (
								pendingComponentWillReceivePropsWarnings.length >
								0
							) {
							...
							var UNSAFE_componentWillReceivePropsUniqueNames =
								/* @__PURE__ */ new Set();
							if (
								pendingUNSAFE_ComponentWillReceivePropsWarnings.length >
								0
							) {
							...
							var UNSAFE_componentWillUpdateUniqueNames =
								/* @__PURE__ */ new Set();
							if (
								pendingUNSAFE_ComponentWillUpdateWarnings.length >
								0
							) {
							...
							if (
								UNSAFE_componentWillReceivePropsUniqueNames.size >
								0
							) {
					...
					ReactStrictModeWarnings.recordLegacyContextWarning =
						function (fiber, instance) {
							...
							var warningsForRoot =
								pendingLegacyContextWarning.get(strictRoot);
							if (
				...
				var warnForMissingKey = function (child, returnFiber) {};
				{
					...
					warnForMissingKey = function (child, returnFiber) {
						...
						var componentName =
							getComponentNameFromFiber(returnFiber) ||
							"Component";
				...
				function ChildReconciler(shouldTrackSideEffects) {
					...
					function updatePortal(
						...
						if (
							...
							current2.stateNode.containerInfo !==
								portal.containerInfo ||
							current2.stateNode.implementation !==
					...
					function reconcileChildrenIterator(
						...
						}
						{
							if (
								...
								newChildrenIterable[Symbol.toStringTag] ===
									"Generator"
							) {
							...
							if (child.key === key) {
								...
								if (elementType === REACT_FRAGMENT_TYPE) {
									if (child.tag === Fragment) {
										...
										existing.return = returnFiber;
										{
											existing._debugSource =
												element._source;
											existing._debugOwner =
												element._owner;
										}
										return existing;
									}
									...
									if (
										...
										{
											_existing._debugSource =
												element._source;
											_existing._debugOwner =
												element._owner;
										}
										return _existing;
									}
				...
				function propagateContextChange_eager(
					...
					while (fiber !== null) {
						...
						if (list !== null) {
							...
							while (dependency !== null) {
								if (dependency.context === context) {
									if (fiber.tag === ClassComponent) {
										var lane =
											pickArbitraryLane(renderLanes2);
							...
							nextFiber =
								fiber.type === workInProgress2.type
									? null
									: fiber.child;
				...
				function markUpdateLaneFromFiberToRoot(sourceFiber, lane) {
					...
					}
					{
						if (
							alternate === null &&
							(sourceFiber.flags & (Placement | Hydrating)) !==
								NoFlags
						) {
					...
					while (parent !== null) {
						...
						if (alternate !== null) {
							...
							{
								if (
									(parent.flags & (Placement | Hydrating)) !==
									NoFlags
								) {
									warnAboutUpdateOnNotYetMountedFiberInDEV(
										sourceFiber,
				...
				function registerMutableSourceForHydration(
					...
					if (root2.mutableSourceEagerHydrationData == null) {
						...
						root2.mutableSourceEagerHydrationData.push(
							mutableSource,
							version,
						);
					}
				...
				function updateHookTypesDev() {
					{
						...
						if (hookTypesDev !== null) {
							...
							if (
								hookTypesDev[hookTypesUpdateIndexDev] !==
								hookName
							) {
				...
				function renderWithHooks(
					...
					currentlyRenderingFiber$1 = workInProgress2;
					{
						...
						ignorePreviousDependencies =
							current2 !== null &&
							current2.type !== workInProgress2.type;
					}
				...
				function dispatchReducerAction(fiber, queue, action) {
					...
					if (isRenderPhaseUpdate(fiber)) {
						...
						var root2 = enqueueConcurrentHookUpdate(
							fiber,
							queue,
							update,
							lane,
				...
				function applyDerivedStateFromProps(
					...
					);
					{
						if (workInProgress2.mode & StrictLegacyMode) {
							setIsStrictModeForDevtools(true);
							try {
								partialState = getDerivedStateFromProps(
									nextProps,
									prevState,
								);
							} finally {
					...
					var instance = workInProgress2.stateNode;
					{
						...
						}
						{
							if (
								...
								!didWarnAboutLegacyContext$1.has(ctor) && // Strict Mode has its own warning for legacy context, so we can skip
								// this one.
								(workInProgress2.mode & StrictLegacyMode) ===
									NoMode
							) {
						...
						if (
							...
							typeof instance.shouldComponentUpdate !==
								"undefined"
						) {
							error(
						...
						if (
							typeof instance.componentDidReceiveProps ===
							"function"
						) {
							error(
						...
						if (
							typeof instance.componentWillRecieveProps ===
							"function"
						) {
							error(
						...
						if (
							typeof instance.getDerivedStateFromProps ===
							"function"
						) {
							error(
						...
						if (
							typeof instance.getDerivedStateFromError ===
							"function"
						) {
							error(
				...
				function mountClassInstance(
					...
					if (typeof instance.componentDidMount === "function") {
						...
						if (
							(workInProgress2.mode & StrictEffectsMode) !==
							NoMode
						) {
							fiberFlags |= MountLayoutDev;
						}
				...
				function createClassErrorUpdate(fiber, errorInfo, lane) {
					...
					if (
						...
						update.callback = function callback() {
							...
							{
								if (
									typeof getDerivedStateFromError !==
									"function"
								) {
									if (
				...
				function throwException(
					...
					if (
						...
						resetSuspendedComponent(sourceFiber);
						{
							if (
								getIsHydrating() &&
								sourceFiber.mode & ConcurrentMode
							) {
						...
						switch (workInProgress2.tag) {
							...
							case ClassComponent:
								...
								if (
									...
									workInProgress2.flags |= ShouldCapture;
									var _lane =
										pickArbitraryLane(rootRenderLanes);
									workInProgress2.lanes = mergeLanes(
										workInProgress2.lanes,
										_lane,
									);
				...
				function updateMemoComponent(
					...
					if (current2 === null) {
						...
						if (
							...
							{
								resolvedType =
									resolveFunctionForHotReloading(type);
							}
				...
				function updateSimpleMemoComponent(
					...
					if (current2 !== null) {
						...
						if (
							...
							workInProgress2.pendingProps = nextProps =
								prevProps;
							if (
				...
				function updateOffscreenComponent(
					...
					if (nextProps.mode === "hidden" || enableLegacyHidden) {
						if (
							...
							!includesSomeLane(renderLanes2, OffscreenLane)
						) {
				...
				) {
					{
						switch (shouldError(workInProgress2)) {
							case false: {
								...
								_instance.updater.enqueueSetState(
									_instance,
									state,
									null,
								);
				...
				function updateHostComponent(
					...
					var nextProps = workInProgress2.pendingProps;
					var prevProps =
						current2 !== null ? current2.memoizedProps : null;
					var nextChildren = nextProps.children;
				...
				function mountDehydratedSuspenseComponent(
					...
					if ((workInProgress2.mode & ConcurrentMode) === NoMode) {
						...
						workInProgress2.lanes =
							laneToLanes(DefaultHydrationLane);
					} else {
				...
				function beginWork(current2, workInProgress2, renderLanes2) {
					{
						if (
							workInProgress2._debugNeedsRemount &&
							current2 !== null
						) {
							return remountFiber(
								current2,
					...
					if (!didBailout) {
						...
						if ((completedWork.mode & ProfileMode) !== NoMode) {
							...
							while (_child2 !== null) {
								...
								subtreeFlags |=
									_child2.subtreeFlags & StaticMask;
							...
							while (_child3 !== null) {
								...
								subtreeFlags |=
									_child3.subtreeFlags & StaticMask;
				...
				function completeDehydratedSuspenseBoundary(
					...
					if (nextState !== null && nextState.dehydrated !== null) {
						if (current2 === null) {
							...
							{
								if (
									(workInProgress2.mode & ProfileMode) !==
									NoMode
								) {
							...
							if (renderedTail === null) {
								if (!didSuspendAlready) {
									var cannotBeSuspended =
										...
										(current2 === null ||
											(current2.flags & DidCapture) ===
												NoFlags);
									if (!cannotBeSuspended) {
										var row = workInProgress2.child;
										while (row !== null) {
											var suspended =
												findFirstSuspended(row);
											if (suspended !== null) {
								...
								if (!didSuspendAlready) {
									var _suspended =
										findFirstSuspended(renderedTail);
									if (_suspended !== null) {
										workInProgress2.flags |= DidCapture;
										didSuspendAlready = true;
										var _newThenables =
											_suspended.updateQueue;
				...
				function commitBeforeMutationEffects_begin() {
					while (nextEffect !== null) {
						...
						var child = fiber.child;
						if (
							(fiber.subtreeFlags & BeforeMutationMask) !==
								NoFlags &&
							child !== null
						) {
							child.return = fiber;
				...
				function commitPassiveEffectDurations(
					finishedRoot,
					finishedWork,
				) {
					{
						if ((finishedWork.flags & Update) !== NoFlags) {
							switch (finishedWork.tag) {
								case Profiler: {
									...
									var _finishedWork$memoize =
											finishedWork.memoizedProps,
										id = _finishedWork$memoize.id,
										onPostCommit =
											_finishedWork$memoize.onPostCommit;
					...
					switch (deletedFiber.tag) {
						...
						case HostPortal: {
							{
								...
								var _prevHostParentIsContainer =
									hostParentIsContainer;
								hostParent =
						...
						case ClassComponent: {
							if (!offscreenSubtreeWasHidden) {
								...
								if (
									typeof instance.componentWillUnmount ===
									"function"
								) {
					...
					switch (finishedWork.tag) {
						...
						case SuspenseComponent: {
							...
							if (offscreenFiber.flags & Visibility) {
								var offscreenInstance =
									offscreenFiber.stateNode;
							...
							if (flags & Visibility) {
								...
								_offscreenInstance.isHidden = _isHidden;
								{
									if (_isHidden) {
										if (!_wasHidden) {
											if (
												(offscreenBoundary.mode &
													ConcurrentMode) !==
												NoMode
											) {
												nextEffect = offscreenBoundary;
												var offscreenChild =
													offscreenBoundary.child;
												while (
													offscreenChild !== null
												) {
				...
				function commitLayoutEffects_begin(
					...
					var isModernRoot =
						(subtreeRoot.mode & ConcurrentMode) !== NoMode;
					while (nextEffect !== null) {
						var fiber = nextEffect;
						...
						if (fiber.tag === OffscreenComponent && isModernRoot) {
							...
							if (newOffscreenSubtreeIsHidden) {
								...
								var prevOffscreenSubtreeIsHidden =
				...
				if (typeof Symbol === "function" && Symbol.for) {
					...
					HAS_PSEUDO_CLASS_TYPE = symbolFor(
				...
				function requestUpdateLane(fiber) {
					...
					var isTransition =
						requestCurrentTransition() !== NoTransition;
					if (isTransition) {
						if (ReactCurrentBatchConfig$3.transition !== null) {
							var transition =
								ReactCurrentBatchConfig$3.transition;
							if (!transition._updatedFibers) {
								transition._updatedFibers =
									/* @__PURE__ */ new Set();
							}
				...
				function ensureRootIsScheduled(root2, currentTime) {
					...
					if (newCallbackPriority === SyncLane) {
						if (root2.tag === LegacyRoot) {
							if (
								ReactCurrentActQueue$1.isBatchingLegacy !== null
							) {
						...
						}
						{
							if (ReactCurrentActQueue$1.current !== null) {
								ReactCurrentActQueue$1.current.push(
									flushSyncCallbacks,
								);
							} else {
						...
						case RootSuspended: {
							...
							if (
								...
								if (msUntilTimeout > 10) {
									...
									var suspendedLanes = root2.suspendedLanes;
									if (
										!isSubsetOfLanes(suspendedLanes, lanes)
									) {
										var eventTime = requestEventTime();
						...
						case RootSuspendedWithDelay: {
							...
							if (!shouldForceFlushFallbacksInDEV()) {
								var mostRecentEventTime =
									getMostRecentEventTime(root2, lanes);
								var eventTimeMs = mostRecentEventTime;
								var timeElapsedMs = now() - eventTimeMs;
								var _msUntilTimeout =
									jnd(timeElapsedMs) - timeElapsedMs;
				...
				function isRenderConsistentWithExternalStores(finishedWork) {
					...
					while (true) {
						...
						var child = node.child;
						if (
							node.subtreeFlags & StoreConsistency &&
							child !== null
						) {
							child.return = node;
							node = child;
					...
					if (
						...
						if (
							...
							(workInProgressRootExitStatus === RootSuspended &&
								...
								now() - globalMostRecentFallbackTime <
									FALLBACK_THROTTLE_MS)
						) {
							prepareFreshStack(root2, NoLanes);
						} else {
				...
				function invokeEffectsInDev(
				...
				) {
					{
						...
						while (current2 !== null) {
							var primarySubtreeFlag =
								current2.subtreeFlags & fiberFlags;
							if (
				...
				var beginWork$1;
				{
					...
					beginWork$1 = function (current2, unitOfWork, lanes) {
						var originalWorkInProgressCopy =
							assignFiberPropertiesInDEV(dummyFiber, unitOfWork);
						try {
				...
				function restorePendingUpdaters(root2, lanes) {
					{
						if (isDevToolsPresent) {
							var memoizedUpdaters = root2.memoizedUpdaters;
							memoizedUpdaters.forEach(
								function (schedulingFiber) {
									addFiberToLanesMap(
										root2,
										schedulingFiber,
										lanes,
				...
				function resolveForwardRefForHotReloading(type) {
					{
						...
						if (family === void 0) {
							if (
								...
								var currentRender =
									resolveFunctionForHotReloading(type.render);
				...
				function scheduleFibersWithFamiliesRecursively(
				...
				) {
					{
						...
						if (needsRemount || needsRender) {
							var _root = enqueueConcurrentRenderForLane(
								fiber,
								SyncLane,
							);
							if (_root !== null) {
				...
				function createWorkInProgress(current2, pendingProps) {
					...
					if (workInProgress2 === null) {
						...
						{
							workInProgress2._debugSource =
								current2._debugSource;
							workInProgress2._debugOwner = current2._debugOwner;
							workInProgress2._debugHookTypes =
								current2._debugHookTypes;
						}
					...
					{
						workInProgress2.selfBaseDuration =
							current2.selfBaseDuration;
						workInProgress2.treeBaseDuration =
							current2.treeBaseDuration;
					}
					{
						workInProgress2._debugNeedsRemount =
							current2._debugNeedsRemount;
						switch (workInProgress2.tag) {
							case IndeterminateComponent:
							case FunctionComponent:
							case SimpleMemoComponent:
							...
							case ClassComponent:
								workInProgress2.type =
									resolveClassForHotReloading(current2.type);
								break;
							case ForwardRef:
								workInProgress2.type =
				...
				function createFiberFromTypeAndProps(
					...
					if (typeof type === "function") {
						if (shouldConstruct$1(type)) {
							...
							{
								resolvedType =
									resolveClassForHotReloading(resolvedType);
							}
						} else {
							{
								resolvedType =
				...
				function attemptSynchronousHydration$1(fiber) {
					switch (fiber.tag) {
						case HostRoot: {
							...
							if (isRootDehydrated(root2)) {
								var lanes =
									getHighestPriorityPendingLanes(root2);
...
react-dom/cjs/react-dom.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ECDLP2BU.js.map
